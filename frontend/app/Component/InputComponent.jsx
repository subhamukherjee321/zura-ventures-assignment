  ...
  return (
    <div className="text-sm relative">
      ...
      {type === "password" && (
        ...
        {show ? (
          <div
            className="flex   items-center justify-end absolute w-10 pt-0 cursor-pointer 2xl:top-1 bottom-3 right-2"
          ...
          <div
            className="flex items-center justify-end absolute w-10 pt-1 cursor-pointer 2xl:top-11 bottom-3 right-2"
            onClick={() => setShow(!show)}
          >
            <svg
              width="22"
